/**
 * SI Testing Module - Screen 1: Team Selection
 *
...
function SITestingTeamSelectionPage() {
  ...
  if (error) {
    return (
      <div className="ei-testing-container">
        <div className="card">
          <h1>Тестирование социального интеллекта</h1>
...
export default SITestingTeamSelectionPage;
